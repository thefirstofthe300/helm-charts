...
*/}}
{{- define "paperless-ngx.redisConnectionString" -}}
{{- if .Values.redis.usePassword }}
{{- printf "redis://%s:%s@%s:%d" .Values.redis.username .Values.redis.password .Values.redis.host .Values.redis.port }}
{{- else if .Values.redis.requirePass }}
{{- printf "redis://:%s@%s:%d" .Values.redis.password .Values.redis.host .Values.redis.port }}
{{- else }}
{{- printf "redis://%s:%d" .Values.redis.host .Values.redis.port }}
{{- end }}
{{- end }}
